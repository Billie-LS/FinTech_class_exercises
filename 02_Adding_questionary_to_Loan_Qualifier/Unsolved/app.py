...
def get_applicant_info():
    ...
    debt = float(debt)
    income = questionary.text("how much income do you earn?").ask()
    income = float(income)
    home_value = questionary.text("what's your house valued at?").ask()
    home_value = float(home_value)
    loan_amount = questionary.text("how much do you want to borrow?").ask()
...
def find_qualifying_loans(bank_data, credit_score, debt, income, loan, home_value):
    ...
    print(
        f"Found {len(bank_data_filtered)} {bank_data_filtered}qualifying loans")
